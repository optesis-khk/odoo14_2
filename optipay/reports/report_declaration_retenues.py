...
class DeclarationRetenues(models.TransientModel):
    ...
    nb_male = fields.Float("nb_male")
    nb_female = fields.Float("nb_female")
    
    total_brut_male = fields.Float("total_brut_male")
    total_ir_male = fields.Float("total_ir_male")
    total_trimf_male = fields.Float("total_trimf_male")
    total_cfce_male = fields.Float("total_cfce_male")

    total_brut_female = fields.Float("total_brut_female")
    total_ir_female = fields.Float("total_ir_female")
    total_trimf_female = fields.Float("total_trimf_female")
    total_cfce_female = fields.Float("total_cfce_female")
