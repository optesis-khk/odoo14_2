...
class CotisationIpresReport(models.TransientModel):
    ...
    total_ipres_rc = fields.Float('total Ipres RC')
    total_ipres_rg = fields.Float('total Ipres RG')
    total_ipres_rc_pat = fields.Float('total Ipres RC Pat')
    total_ipres_rg_pat = fields.Float('total Ipres RG Pat')
    total_base_rc = fields.Float('total base RC')
    total_base_rg = fields.Float('total base RG')
    
    line_base_rg = fields.Float('base RG')
    line_base_rc = fields.Float('base RC')
    line_brut = fields.Float('line brut')
    line_ipres_rc = fields.Float('Ipres RC')
    line_ipres_rg = fields.Float('Ipres RG')
    line_ipres_rc_pat = fields.Float('Ipres RC Pat')
    line_ipres_rg_pat = fields.Float('Ipres RG Pat')
